...
export const AbstractNodeId_new_parameter: (a: number) => number;
...
export const OperationBuilder_create: (a: number) => number;
export const OperationBuilder_expect_parameter_node: (a: number, b: number, c: number) => void;
export const OperationBuilder_expect_context_node: (a: number, b: number, c: number) => void;
export const OperationBuilder_expect_parameter_edge: (a: number, b: number, c: number, d: number, e: number) => void;
