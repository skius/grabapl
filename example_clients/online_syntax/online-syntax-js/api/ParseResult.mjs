...
import { RunOperationResult } from "./RunOperationResult.mjs"
...
export class ParseResult {
    ...
    runOperation(g, opName, args) {
        ...
        try {
            ...
            return new RunOperationResult(diplomatRuntime.internalConstructor, diplomatRuntime.ptrRead(wasm, diplomatReceive.buffer), []);
        }
