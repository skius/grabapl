...
export class Context {
    ...
    static parse(src) {
        ...
        const result = wasm.Context_parse(diplomatReceive.buffer, ...srcSlice.splat());

        try {
            if (!diplomatReceive.resultFlag) {
                const cause = new ParseError(diplomatRuntime.internalConstructor, diplomatRuntime.ptrRead(wasm, diplomatReceive.buffer), []);
                throw new globalThis.Error('ParseError: ' + cause.toString(), { cause });
            }
            return new ParseResult(diplomatRuntime.internalConstructor, diplomatRuntime.ptrRead(wasm, diplomatReceive.buffer), []);
        }
